...
const ProjectCard = ({ title, description, tags, imageUrl }) => {
  ...
  return (
    ...
    > 
      <section className="relative bg-gray-100 dark:bg-white/10 dark:hover:bg-white/20 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem] hover:bg-gray-200 dark:text-white transition rounded-xl">
